...
- `.github/workflows/serp-relevance-batch.yml` turns a private-data facility CSV into a bounded SERP matrix, then stores each response with the same raw object contract.
